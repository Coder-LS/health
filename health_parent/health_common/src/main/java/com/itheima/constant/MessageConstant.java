...
public class MessageConstant {
    ...
    public static final String ORDER_CANCEL_SUCCESS = "取消预约成功";
    public static final String ORDER_CANCEL_FAIL = "取消预约失败";
    ...
    public static final String ADD_SINGLE_PERMISSION_SUCCESS = "新增权限数据成功";
    public static final String ADD_SINGLE_PERMISSION_FAIL = "新增权限数据失败";
    public static final String GET_ALLROLE_SUCCESS = "查询所有角色成功";
    public static final String GET_ALLROLE_FAIL = "查询所有角色失败";
    public static final String GET_ALLPERMISSIONS_SUCCESS = "查询所有权限成功";
    public static final String GET_ALLPERMISSIONS_FAIL = "查询所有权限失败";

    public static final String ADD_ROLE_FAIL = "添加角色失败";
    public static final String ADD_ROLE_SUCCESS = "添加角色成功";
    public static final String ADD_PERMISSIONS_FAIL = "添加角色权限失败";
    public static final String ADD_PERMISSIONS_SUCCESS = "添加角色权限成功";
    ...
    public static final String GET_ALLADDRESS_SUCCESS = "查询所有地址成功";
    public static final String GET_ALLADDRESS_FAIL = "查询所有地址失败";
}